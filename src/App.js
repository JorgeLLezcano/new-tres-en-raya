...
export default function App() {
  ...
  const shouldShowLine = (condition) => {
    if (winner && bloque[condition[0]] === winner && bloque[condition[1]] === winner && bloque[condition[2]] === winner) {
      return true;
    }
    return false;
  };
